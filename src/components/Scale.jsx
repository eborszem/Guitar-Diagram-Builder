...
export const Scale = ({
    ...
    return (
        <div className="scale-interface">
            <p className="settings-block-header">scale generator</p>
            <div className="scale-dropdown-wrapper">
                ...
                <div className="label-and-dropdown">
                    <label className="settings-block-label">scale</label>
                    <select
                        id="scale"
                        className="scale-dropdown"
                        value={scale}
                ...
                <div className="label-and-dropdown">
                    <label className="settings-block-label" style={{ visibility: "hidden" }}>.</label>
